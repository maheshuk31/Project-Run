...
//        assertFalse("The password doesn't allow a assortment of letters and numbers", holder);
//    }
//
//    @Test
//    public void testEmailSending(){
//        EmailSender emailSender = new EmailSender(this.getContext(), "mahesh.bhudia@kcl.ac.uk", "test", "test message");
