package com.example.lee.projectrun.MainComponentsInformation;
...
{
    private static final String AUTHENTICATION_SERVER_ADDRESS = "http://projectrun.x10host.com";

    //Default listeningPort. This will be changed later.
    private int listeningPort = 0;

    //This string will be activated if a connection fails
    ...
    public SocketConnection(IUserMessageNetworkManager appManager) {
    }
