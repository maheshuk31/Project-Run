...
public class LoggingIn extends Activity {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            {
                Intent i = new Intent(LoggingIn.this, ListFriend.class);
                startActivity(i);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Login");
        usernameText = userInformation.getUniqueCode();
        passwordText = userInformation.getPassword();
                        ...
                        passwordText.length() > 0)
                {
                    ...
                    Thread loginThread = new Thread(){
                        ...
                        public void run() {
                            String result = null;
                            try {
                                result = imService.authenticateUser(usernameText, passwordText);
