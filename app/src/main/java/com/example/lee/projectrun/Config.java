...
public class Config
{
    ...
    public static final String URL_GetUser = "http://projectrun.x10host.com/RetrieveUser.php";
    public static final String URL_GetAllUsers = "http://projectrun.x10host.com/GetAllUsers.php";
